...
class DoomscrollDetector:
    def __init__(self):
        ...
        # Roasting messages
        self.roasts.extend([
    "ഫോൺ നോക്കി നിൽക്കുന്നത് കൊണ്ട് ലക്ഷ്യം നേടാൻ പറ്റില്ലേ!",
    "ഇനി ഒന്ന് ജോലി ചെയ്യാമോ മഹാരാണി?",
    "സ്ക്രോൾ ചെയ്യുന്നത് കൊണ്ട് ഡെഡ്‌ലൈനുകൾ മാറില്ല!",
    "നിന്റെ future നിന്നെ കാത്തിരിക്കുന്നു, ഫോൺ അല്ല!",
    "ഇത്രയും സ്ക്രോൾ ചെയ്‌താൽ വിജയം download ആകില്ല!",
    "മതി മതി... ഫോൺ വച്ചിട്ട് ഒന്ന് focus ചെയ്യ്!",
    "നിന്റെ സ്വപ്നങ്ങൾ buffering ആണേ!",
    "Algorithm വീണ്ടും ജയിച്ചു... നീ തോറ്റു!",
    "ഇത് തന്നെയാണോ productivity എന്ന് വിളിക്കുന്നത്?",
    "ഇനി ഒരു reel കൂടി കണ്ടാൽ career logout ആവും!",
    "ഫോൺ വച്ചിട്ട് എഴുന്നേറ്റ് champion ആകു!",
    "സ്ക്രോൾ ചെയ്യാൻ അല്ലേ ജനിച്ചത്?",
    "Focus mode എവിടെ പോയി?",
    "ഇനി ഒരു 5 മിനിറ്റ് എന്ന് പറഞ്ഞ് 2 മണിക്കൂർ ആയി!",
    "Work ചെയ്യാതെ success വരുമെന്ന് കരുതണ്ട!"
])
